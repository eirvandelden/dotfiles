...
#
# NOTE: Modern macOS uses “System Settings” (not “System Preferences”).
# Keeping this commented out to avoid errors on newer macOS versions.
...
defaults write NSGlobalDomain AppleLocale -string "nl@currency=EUR"
...
defaults write ~/Library/Preferences/org.gpgtools.gpgmail SignNewEmailsByDefault -bool enable
