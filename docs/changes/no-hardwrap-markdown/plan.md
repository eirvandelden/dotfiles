...
- `claude/.claude/hooks/markdown-hardwrap.rb`: `test_a_missing_file_tells_claude_nothing`, `test_missing_markdownlint_tells_claude_nothing`, `test_the_hook_always_exits_zero`, `test_a_markdown_file_with_a_long_extension_or_upper_case_is_checked`.
