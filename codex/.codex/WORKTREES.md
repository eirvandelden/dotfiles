...
Mechanics: `worktree-first` skill (`codex/.codex/skills/worktree-first/`). Invoke it before
starting any code-writing task; it also skips itself when already inside a worktree or when the
user asked to work in place.
